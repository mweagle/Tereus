...
!function (t, e) {
    ...
    function dt(t, e, r) {
        var n = d(t), i = (w(t) ? Ie() : Lt()).asMutable();
    ...
    function mt(t, e, r, n) {
        ...
        return _.size = 0 === c ? c : t.size && c || void 0, !n && L(t) && c >= 0 && (_.get = function (e, r) {
            ...
            var i = c && t.__iterator(e, r), u = 0, s = 0;
            return new S(function () {
                for (; u++ < o;)i.next();
                if (++s > c)return I();
                var t = i.next();
    ...
    function St(t, e) {
        var r = d(t), n = [t].concat(e).map(function (t) {
    ...
    function qt(t, e, r) {
        e || (e = Ut);
        var n = d(t), i = 0, o = t.toSeq().map(function (e, n) {
    ...
    function Zt(t, e, r, n, i) {
        ...
        var o, u = (0 === r ? t.keyHash : t.keyHash >>> r) & fr, s = (0 === r ? n : n >>> r) & fr, a = u === s ? [Zt(t, e, r + ar, n, i)] : (o = new Pt(e, n, i),
            s > u ? [t, o] : [o, t]);
    ...
    function pe(t, e) {
        ...
        var o = t._origin, u = t._capacity, s = ze(u), a = t._tail;
    ...
    function de(t, e, n, i, o, u) {
        var s = i >>> n & fr, a = t && t.array.length > s;
        if (!a && void 0 === o)return t;
        var h;
        if (n > 0) {
            var f = t && t.array[s], c = de(f, e, n - ar, i, o, u);
    ...
    function nr(t) {
        ...
        var e = w(t), r = d(t), n = e ? 1 : 0, i = t.__iterate(r ? e ? function (t, e) {
    ...
    var ur = Array.prototype.slice, sr = "delete", ar = 5, hr = 1 << ar, fr = hr - 1, cr = {}, _r = {value: !1}, pr = {value: !1};
    ...
    }, Er = Object.isExtensible, Or = function () {
        try {
    ...
    t(at, x), at.prototype.get = function (t, e) {
        ...
        var t = this, e = vt(this, !0);
        return this._useKeys || (e.valueSeq = function () {
            return t._iter.toSeq().reverse()
        }), e
    }, at.prototype.map = function (t, e) {
        var r = this, n = pt(this, t, e);
        ...
        var r = this._iter.__iterator(gr, e), n = 0;
        return new S(function () {
            var e = r.next();
    ...
    t(fe, Y), fe.of = function () {
        ...
        for (var r, n = 0, i = pe(this, e); (r = i()) !== Vr && t(r, n++, this) !== !1;);
        return n
    ...
    var Pr = "@@__IMMUTABLE_LIST__@@", Hr = fe.prototype;
    ...
    var rn = Ce.prototype;
    rn[sr] = rn.remove, rn.deleteIn = rn.removeIn = Tr.removeIn,
    ...
    _.Iterator = S, Xe(_, {
        toArray: function () {
            ...
            return t = "function" == typeof t.includes ? t : _(t),
    ...
    sn[lr] = !0, sn[Ir] = un.entries, sn.__toJS = un.toObject, sn.__toStringMapper = function (t, e) {
        ...
        toKeyedSeq: function () {
            ...
            var t = [this].concat(i(arguments)), e = Et(this.toSeq(), k.of, t), r = e.flatten(!0);
    ...
    }), l.prototype.has = un.includes, Xe(x, p.prototype), Xe(k, v.prototype), Xe(A, l.prototype), Xe(V, p.prototype), Xe(Y, v.prototype),
        Xe(Q, l.prototype);
    var an = {
        Iterable: _,
        Seq: O,
